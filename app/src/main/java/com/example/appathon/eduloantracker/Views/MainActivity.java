...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView textView;
    @BindView(R.id.get_loan)
    TextView getLoan;
    @BindView(R.id.loan_txt)
    TextView loanTxt;
...
/*
    ...
    private void setClicks() {
        ...
        balbt.setOnClickListener(this);
        getLoan.setOnClickListener(this);
